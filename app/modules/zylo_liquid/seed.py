...
KNOWN_PERMISSIONS = [
    ...
    (PUMP_READ, "Consulter les pompes."),
    (PUMP_MANAGE, "Gérer les pompes (créer, modifier)."),
    ...
    (GPS_DEVICE_READ, "Consulter le référentiel des boîtiers GPS."),
    (GPS_DEVICE_MANAGE, "Créer/modifier le référentiel des boîtiers GPS."),
    (TRACKING_LOCATION_READ, "Consulter les lieux nommés du tracking camions."),
    (TRACKING_LOCATION_MANAGE, "Créer/modifier/supprimer les lieux nommés du tracking camions."),
    (TRUCK_ORDER_ASSIGNMENT_MANAGE, "Rattacher/détacher un camion à une commande d'approvisionnement."),
    (TRACKING_SETTINGS_MANAGE, "Régler les paramètres de tracking (seuil d'arrêt, rayon, affichage)."),
    (TRACCAR_CONNECTION_MANAGE, "Configurer la connexion à l'API Traccar de l'organisation."),
